    ...
    public function index(): JsonResource
    {
        ...
        if (request()->get('onlyCards') == 1) {
            try {
                ...
                $parentCategory = $this->categoryRepository->getModel()->whereTranslation('slug', 'cards', 'en')->first();
                ...
                $additionalParams = [
                    ...
                    'locale' => 'en', // Force English locale since categories may not be translated
                ];
