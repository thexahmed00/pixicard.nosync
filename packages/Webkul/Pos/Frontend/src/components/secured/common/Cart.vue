<template>
    <div class="fixed flex h-[calc(100vh-68px)] w-[420px] max-w-full flex-col justify-between bg-white shadow-[1px_0px_0px_0px_rgba(0,0,0,0.1)_inset] max-sm:w-full 2xl:w-[460px] ltr:right-0 rtl:left-0">
        <div class="grid px-3">
            <div class="py-4 shadow-[0px_-1px_0px_0px_rgba(0,0,0,0.1)_inset]">
            ...
            <div class="h-[calc(100vh-425px)] overflow-y-auto py-2">
                <div
                    class="grid min-h-14 gap-4 rounded-lg p-2"
                    :class="{
            ...
            <div class="mt-2.5 flex h-14 items-center justify-between rounded-lg bg-light px-4">
        ...
        <div class="grid gap-4 bg-extraLight p-3">
