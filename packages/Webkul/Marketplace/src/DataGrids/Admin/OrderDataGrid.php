...
class OrderDataGrid extends DataGrid
{
    ...
    public function prepareQueryBuilder(): Builder
    {
        ...
        $queryBuilder = DB::table('marketplace_orders')
            ...
            ->addSelect(
                DB::raw('CONCAT('.$tablePrefix.'orders.customer_first_name, " ", '.$tablePrefix.'orders.customer_last_name) as customer_name'), 'orders.increment_id',
        ...
        $this->addFilter('location', DB::raw('CONCAT('.$tablePrefix.'order_address_billing.city, ", ", '.$tablePrefix.'order_address_billing.state,", ", '.$tablePrefix.'order_address_billing.country)'));
