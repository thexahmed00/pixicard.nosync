                ...
                if ($file instanceof UploadedFile) {
                    if (Str::contains($file->getMimeType(), 'image')) {
                        ...
                        try {
                            ...
                            Log::error('BAGISTO IMAGE UPLOAD FAILED: ' . $e->getMessage());
                            Log::error('Error occurred in file: ' . $e->getFile() . ' on line: ' . $e->getLine());

                            // To ensure the request fails and you see the error immediately
                            // You might want to throw the exception again during testing
                            throw $e;
                        }
                    } else {
